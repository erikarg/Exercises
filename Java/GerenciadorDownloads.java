...
// de download dos pacotes. Mas como o espaço para essa informação ficou
// pequeno, a empresa optou por fazer uma escala de 10 – 1.
...
public class GerenciadorDownloads {
    public static void main(String[] args) {
        ...
        leitor.close();
        String ch = "/";
        String output = ch.repeat(tamanho);
