...
def test_expression_maximum_are_thirty_chars():
    ...
    with pytest.raises(ValueError):
        find_phone_number(long_expression)


def test_expression_with_invalid_chars():
    with pytest.raises(ValueError):
        find_phone_number("I-****-MY_JOB")
